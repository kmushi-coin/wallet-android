...
import com.kmushi.core.coins.BitcoinTest;
import com.kmushi.core.coins.CoinType;
import com.kmushi.core.coins.DashMain;
...
import com.kmushi.core.coins.NuSharesMain;
...
//        assertEquals(BTC, uri.getType());
    ...
    public void testAddressRequest() throws Exception {
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://kmushicoin.com/", uri.getAddressRequestUri().toString());
        assertEquals("https://kmushicoin.com/?address=" + MAINNET_GOOD_ADDRESS,
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://kmushicoin.com/some-path?abc=xyz", uri.getAddressRequestUri().toString());
        assertEquals("https://kmushicoin.com/some-path?abc=xyz&address=" + MAINNET_GOOD_ADDRESS,
                uri.getAddressRequestUriResponse(MAINNET_GOOD_ADDRESS).toString());
        ...
        assertEquals("https://kmushicoin.com/", uri.getAddressRequestUri().toString());
        assertEquals("https://kmushicoin.com/?address=" + goodAddressStr,
