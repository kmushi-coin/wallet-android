package com.kmushi.core.coins.nxt;
...
//                + " existing key " + com.kmushi.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.kmushi.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.kmushi.core.coins.nxt.Crypto.rsDecode(com.kmushi.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.kmushi.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.kmushi.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.kmushi.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.kmushi.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.kmushi.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.kmushi.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
